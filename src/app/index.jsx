...
import Home from './themes/angelo/pages/home/home';
import Dashboard from './themes/angelo/pages/dashboard/dashboard';
import AccountSettings from './themes/angelo/pages/account/settings';
import AccountNotifications from './themes/angelo/pages/account/notifications';
import Listing from './themes/angelo/pages/listing/listing';
import Page from './themes/angelo/pages/page/page';
import Post from './themes/angelo/pages/post/post';
import Course from './themes/angelo/pages/course/course';
import Subject from './themes/angelo/pages/subject/subject';
import Module from './themes/angelo/pages/module/module';
import Activity from './themes/angelo/pages/activity/activity';
import NotFound from './themes/angelo/pages/notFound/notFound';
